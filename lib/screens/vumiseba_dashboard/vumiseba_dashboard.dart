              ...
              title: Column(
                ...
                children: [
                  Text(
                    "স্বাগতম".tr,
                    style:
                        customTextStyle(14.sp, Colors.black, FontWeight.w500),
                  ),
                  Text(
                    "Vumi Seba".tr,
                    style:
                    ...
                    Wrap(
                      ...
                      children: [
                        InkWell(
                          ...
                          child: customDashboardCard("ভূমি সেবা".tr,
                              "images/icons/icon_landservice.png"),
                        ),
                        InkWell(
                          onTap: () {
                            Navigator.of(context).push(MaterialPageRoute(
                        ...
                        InkWell(
                          ...
                          child: customDashboardCard("অন্যান্য অ্যাপ".tr,
                              "images/icons/icon_otherapp.png"),
                        ),
                        InkWell(
                          onTap: () {},
                          child: customDashboardCard("ক্যালকুলেটর".tr,
                              "images/icons/icon_calculator.png"),
                        ),
                        InkWell(
                            onTap: () {},
                            child: customDashboardCard("অন্যান্য সেবা".tr,
                                "images/icons/icon_other.png")),
                      ],
                    ),
                  ],
                ),
